          ...
          <div class="box">
            <div class="box-header with-border">
                <div class="col-xs-6">
                  ...
                  <a href="temporarySaleAdjustment.php"  class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> Sale Adjustment </a>
                </div>
				<div class="col-xs-6">
            ...
            <div class="box-body">
				<table id="manageTSTable" class="table table-bordered" width="100%">
					<thead>
					  <th style="width:6%;">SN#</th>
					  <th style="width:10%;">TS Code</th>
...
<?php include 'includes/scripts.php'; ?>
    ...
    <script src="includes/js/temporarySaleView.js"></script> 
</body>
</html>