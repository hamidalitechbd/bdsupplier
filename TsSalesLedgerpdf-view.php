...
class MYPDF extends TCPDF {
    ...
    $content .= '<style>
		...
		<div class="citiestd13"> Temporary sale Un-adjusted Voucher Information </div>';
	while($row = $query->fetch_assoc()){
		...
		$content .= '<table border="1" cellspacing="0" cellpadding="3">
			<tr>
				<td width="75%" class="supAddress">Customer Name :<font color="gray" class="supAddressFont">'.$partyName.'</font><br>Customer Address :<font color="gray" class="supAddressFont">'.$partyAddress.'</font><br>Contact Person :<font color="gray" class="supAddressFont">'.$contactPerson.' / '.$partyPhone.'</font></td>
				<td width="25%" style="border: 1px solid gray;font-size: 8px;" ><span class="citiestd11">Print Date: ' . date("Y-m-d") .'</span></td>
			</tr>
			<tr>
		...
		<table border="1" cellspacing="0" cellpadding="3">
			<tr>
				...
				<th class="citiestd11" width="15%">Specification</th>
