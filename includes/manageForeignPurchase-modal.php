          	...
          	<div class="modal-body">
				...
				<div class="form-group">
					...
					<label for="add_quantity"> Quantity </label>
                    	<input type="text" class="form-control" id="add_quantity" name="quantity" placeholder=" Add Quantity ">
                  	</div>
				</div>
				...
				<div class="form-group">
					...
					<label for="add_mfgDate"> Mfg. Date </label>
                    	<input type="date" style="line-height: 10px;" class="form-control" id="add_mfgDate" onblur="mfgValidate()" name="mfgDate">
                  	</div>
					<div class="col-sm-6">
					<label for="add_expDate"> Exp. Date </label>
                    	<input type="date" style="line-height: 10px;" class="form-control" id="add_expDate" onblur="expValidate()" name="expDate">
