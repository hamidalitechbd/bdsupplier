  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Walk-in Sale</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
                <div class="col-xs-3">
                  <a href="salesLocal-add.php"  class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> Walk-in Sale </a>
                </div>
                <div class="col-xs-6">
				...
				<div class="col-xs-3">
					...
					<select id="sortData" class="form-control name="sortData" style='float:right;'>
					    ...
					    <?php
    				        ...
    				        echo '<option value="-1,-1">More Search By WI Name</option>';
            ...
            <div class="box-body">
				<table id="manageSalesTable" class="table table-bordered" width="100%">
					<thead>
...
<?php include 'includes/scripts.php'; ?>
    ...
    <script src="includes/js/walkInSaleView.js"></script> 
</body>
</html>